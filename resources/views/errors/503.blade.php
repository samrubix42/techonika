...
<div class="min-h-screen bg-black text-white flex items-center justify-center relative overflow-hidden">
  ...
  <!-- Background Glow -->
  <div class="absolute -top-48 left-1/2 -translate-x-1/2 w-[720px] h-[320px]
  ...
  <div class="relative max-w-3xl mx-auto px-4 text-center">
    ...
    <div class="flex justify-center mb-8">
      <div class="w-20 h-20 rounded-full bg-white/5 border border-white/10
        ...
        <i class="ri-tools-line text-primary text-4xl"></i>
      </div>
    </div>
    ...
    <!-- Message -->
    <p class="mt-6 text-white/60 text-lg max-w-xl mx-auto leading-relaxed">
    ...
    <!-- Status -->
    <div class="mt-10 inline-flex items-center gap-3 px-6 py-3
