                    ...
                    <div class="text-center lg:text-left">
                        ...
                        <h1 class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl
                           font-semibold leading-snug lg:leading-tight">
                            Techonika – A Digital Marketing Company in Noida That Helps
                            <span class="text-primary font-bold block sm:inline">
                                Businesses Get Found, Trusted,
                            </span>
                            and Chosen
                        </h1>
                        ...
                        <div class="mt-5 sm:mt-6 space-y-3 sm:space-y-4
                            ...
                            <p class="text-sm sm:text-base text-white/80 leading-relaxed">
                                Running a business today is not just about having a good product or service.
                                People need to find you online, understand what you do, and feel confident
                                enough to choose you over others.
                            </p>

                            <p class="text-sm sm:text-base text-white/80 leading-relaxed">
                                That is where digital marketing plays a real role. At
                                <span class="text-white font-medium">Techonika</span>, we help businesses
                                grow step by step in the online world.
                            </p>

                            <p class="text-sm sm:text-base text-white/80 leading-relaxed">
                                Our job is to make digital marketing
                                <span class="text-primary font-medium">
                                    simple, measurable, and meaningful
                                </span>
                                for your business.
                            </p>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="mt-6 space-y-4 max-w-xl">
                            <p class="text-white/80 leading-relaxed">
                                Digital marketing is not about being everywhere online. It is about being
                                in the right place, at the right time, with the right message.
                            </p>

                            <p class="text-white/80 leading-relaxed">
                                When done correctly, digital marketing helps people discover your business
                                when they are already looking for something you offer.
                            </p>

                            <p class="text-white/80 leading-relaxed">
                                As a practical digital marketing company in Noida,
                                <span class="text-white font-medium">Techonika</span> focuses on steady,
                                long-term growth instead of quick shortcuts.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="bg-white/5 border border-white/15
                        ...
                        <ul class="space-y-5">
                            <li class="flex gap-4">
                                ...
                                <p class="text-white/80">
                                    Get noticed by the
                                    <span class="text-white font-medium">right audience</span>
                                </p>
                            </li>
                            ...
                            <li class="flex gap-4">
                                ...
                                <p class="text-white/80">
                                    Build trust through
                                    <span class="text-white font-medium">useful and honest content</span>
                                </p>
                            </li>
                        ...
                        <div class="mt-8 pt-6 border-t border-white/10">
                            <p class="text-white/70 text-sm leading-relaxed">
                                ...
                                <span class="text-primary font-medium">
                                    We believe in steady growth that lasts.
                                </span>
                            </p>
                        </div>
                    </div>
