    ...
    <div class="email-container">
        ...
        <div class="email-body">
            ...
            <div class="action-section">
                <p class="action-text">
                    <strong>Quick response increases conversion!</strong><br>
                    Reply within 24 hours for best results.
                </p>
                <a href="mailto:{{ $enquiry->email }}" class="action-button">
                    Reply to Customer
                </a>
            </div>
            ...
            <div class="meta-info">
                <div class="meta-row">
                    ...
                    <span><strong>Submitted:</strong> {{ $enquiry->created_at->format('F d, Y \a\t h:i A') }}</span>
                </div>
                <div class="meta-row">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="email-footer">
            ...
            <p class="footer-text">
                This is an automated notification from your package enquiry form.
            </p>
