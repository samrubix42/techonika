...
use App\Livewire\Admin\Portfolio\SeoPortfolioList;
...
use App\Livewire\Public\Portfolio\Seo as SeoPortfolioPage;
use App\Livewire\Public\Service\Service;
use App\Livewire\Public\Service\ServiceView;
use App\Livewire\Public\Webdesign\AngularWebsiteDesign;
...
Route::get('/seo-portfolio', SeoPortfolioPage::class)->name('seo-portfolio');
...
Route::prefix('admin')->middleware('auth')->name('admin.')->group(function () {
    ...
    Route::get('/seo-portfolio', SeoPortfolioList::class)->name('seo-portfolio.list');
